      ...
      <div className="max-w-screen-xl mx-auto p-2 sm:p-10 md:p-4">
        <div className="border-b mb-5 flex justify-between text-sm">
          ...
          <div className="text-orange-500 flex items-center pb-2 pr-2 border-b-2 border-gray-700 uppercase">
            ...
            <a href="#" className="font-semibold inline-block">Tác giả nổi bật</a>
          </div>
          <a href="#" className='text-gray-400 hover:text-red-700'>Xem tất cả</a>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 gap-5">
                  ...
                  <div className='w-full h-auto px-2'>
                    <div className='flex px-1 bg-white rounded-2'>
                      ...
                      <div className='flex items-center py-1 px-1 justify-between w-full'>
                        <a className='py-1 text-clamp-1 w-40 overflow-hidden'>Lập trình căn bản</a>
                        <a href='' className='text-sm text-lime-600'>683</a>
                      </div>
                    </div>
                    <div className='flex px-1 bg-white rounded-2 py-2'>
                      ...
                      <div className='flex items-center py-1 px-1 justify-between w-full'>
                        <a className='py-1 text-clamp-1 w-40 overflow-hidden'>Lập trình C #</a>
                        <a href='' className='text-sm text-lime-600'>683</a>
                      </div>
                    </div>
                    <div className='flex px-1 bg-white rounded-2'>
              ...
              <Link to='/authur'>
                <div className="p-4 border-t border-gray-200">
                  <div className="text-center">
                    <h1 className="font-medium text-lg inline-block hover:text-indigo-600 transition duration-500 ease-in-out inline-block mb-2">ThS. Trần Quốc Trường</h1>
                  </div>
          ...
          <div className='w-full bg-white shadow rounded border border-transparent'>
            <div className="w-full bg-white shadow rounded border border-transparent hover:border-blue-500 cursor-pointer">
              ...
              <div className="p-4 border-t border-gray-200">
                <div className="text-center">
                  <h1 className="font-medium text-lg inline-block hover:text-indigo-600 transition duration-500 ease-in-out inline-block mb-2">Lê Nguyễn Tất Thắng</h1>
                </div>
                <p className="text-gray-400 text-sm my-1 text-center">Chuyên về lập trình C++, C #</p>
              </div>
            </div>
          ...
          <div className='w-full bg-white shadow rounded border border-transparent'>
            <div className="w-full bg-white shadow rounded border border-transparent hover:border-blue-500 cursor-pointer">
              ...
              <div className="p-4 border-t border-gray-200">
                <div className="text-center">
                  <h1 className="font-medium text-lg inline-block hover:text-indigo-600 transition duration-500 ease-in-out inline-block mb-2">Vũ Tuấn Nghĩa</h1>
                </div>
                <p className="text-gray-400 text-sm my-1 text-center">Chuyên về lập trình C++, C #</p>
              </div>
            </div>
          ...
          <div className='w-full bg-white shadow rounded border border-transparent'>
            <div className="w-full bg-white shadow rounded border border-transparent hover:border-blue-500 cursor-pointer">
              ...
              <div className="p-4 border-t border-gray-200">
                <div className="text-center">
                  <h1 className="font-medium text-lg inline-block hover:text-indigo-600 transition duration-500 ease-in-out inline-block mb-2">ThS. Hồ Đình Khả</h1>
                </div>
                <p className="text-gray-400 text-sm my-1 text-center">Chuyên về lập trình C++, C #</p>
              </div>
            </div>
      ...
      <div className="max-w-screen-xl mx-auto p-2 sm:p-10 md:p-4">
        <div className="border-b mb-5 flex justify-between text-sm">
          <div className="text-orange-500 flex items-center pb-2 pr-2 border-b-2 border-gray-700 uppercase">
            ...
            <a href="#" className="font-semibold inline-block">Thể loại sách được chú ý</a>
          </div>
          <a href="#" className='text-gray-400 hover:text-red-700'>Xem tất cả</a>
        </div>
