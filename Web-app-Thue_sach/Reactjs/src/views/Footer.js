    ...
    return (
        ...
        <footer className="bg-white rounded-lg shadow dark:bg-gray-900 m-4">
            <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8">
                ...
                <span className=" text-sm text-gray-500 sm:text-center dark:text-gray-400 flex justify-center"> © 2023 <div className="hover:underline"> &nbsp;Thuê sách</div>. Lê Nguyễn Tất Thắng - Vũ Tuấn Nghĩa</span>
            </div>
        </footer>
