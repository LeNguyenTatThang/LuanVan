                        ...
                        <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                            ...
                            <div className="space-y-4 md:space-y-6">
                                ...
                                <div className="flex items-center justify-between">
                                    ...
                                    <div className="text-sm font-medium text-primary-600 hover:underline dark:text-primary-500">Quên mật khẩu?</div>
                                </div>
                                ...
                                <p className="text-sm font-light text-gray-500 dark:text-gray-400">
                                    Bạn chưa có tài khoản? <Link to="/signup"><div className="font-medium text-primary-600 hover:underline dark:text-primary-500">Đăng ký tài khoản</div></Link>
                                </p>
                            </div>
                        </div>
                    </div>
