                            ...
                            <div className="grid items-center lg:grid-cols-2">
                                <div className="mb-12 md:mt-12 lg:mt-0 lg:mb-0">
                                    <div
                                        ...
                                        <h2 className="mb-12 text-3xl font-bold">Liên hệ với chúng tôi</h2>
                                        <form>
                                            <div className="relative mb-6" data-te-input-wrapper-init>
                                                ...
                                                <label
                                                    ...
                                                    for="exampleInput90"
                                                >Lê Nguyễn Tất Thắng - Vũ Tuấn Nghĩa
                                                </label>
                                            </div>
                                            <div className="relative mb-6" data-te-input-wrapper-init>
                                                <div
                                                ...
                                                <label
                                                    className="pointer-events-none absolute top-0 left-3 mb-0 max-w-[90%] origin-[0_0] truncate pt-[0.37rem] leading-[1.6] text-neutral-500 transition-all duration-200 ease-out peer-focus:-translate-y-[0.9rem] peer-focus:scale-[0.8] peer-focus:text-primary peer-data-[te-input-state-active]:-translate-y-[0.9rem] peer-data-[te-input-state-active]:scale-[0.8] motion-reduce:transition-none dark:text-neutral-200 dark:peer-focus:text-primary"
                                                    for="exampleInput90"
                                                >Email: thuesachonline@gmail.com
                                                </label>
                                            </div>
                                            <div className="relative mb-6" data-te-input-wrapper-init>
                                                <div
                                ...
                                <div className="md:mb-12 lg:mb-0">
                                    <div
                                        ...
                                        <iframe
                                            src="https://maps.google.com/maps?q=180%20Cao%20Lỗ,%20Ho%20Chi%20Minh%20City&t=&z=13&ie=UTF8&iwloc=&output=embed"
